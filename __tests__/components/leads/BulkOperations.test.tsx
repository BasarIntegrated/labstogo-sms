import BulkOperations from "@/components/leads/BulkOperations";
...
describe("BulkOperations", () => {
  ...
  it("renders when leads are selected", () => {
  ...
  it("does not render when no leads are selected", () => {
    render(<BulkOperations {...mockProps} selectedLeads={[]} />);
  ...
  it("handles single lead selection", () => {
    render(<BulkOperations {...mockProps} selectedLeads={["1"]} />);
